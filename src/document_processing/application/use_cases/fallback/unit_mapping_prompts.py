...
UNIT_MAPPING_SCOPE_TEMPLATE = (
    ...
    "ou por campo interno. Os arrays listados em unidade_mapeamento.colecoes_por_evidencia "
    "sao colecoes: a chave de cada item vem do artefato, entao o esperado e uma "
    "linhas_de_tabela no path desse array cobrindo todas as linhas publicadas, com "
    "campos para cada campo terminal lido por coluna e valores_por_segmento ou "
    "valores_fixos para o contexto constante. Nesse path, mantenha os filtros dos "
    "arrays ancestrais e nao coloque filtro no proprio array, por exemplo "
    "grupo.dados[chave=valor].itens. Uma entrada por item filtrado nessas colecoes "
    "so e aceitavel quando a evidencia publica um unico item. "
