...
def candidate_contract_instruction() -> str:
    ...
    return (
        ...
        "por linhas_de_tabela, use o path da colecao sem filtro no proprio array, "
        "mantendo obrigatoriamente os filtros dos arrays ancestrais, por exemplo "
        "colecao.itens ou grupo.dados[chave=valor].itens; a chave de cada item deve "
        "ser lida de uma coluna em campos, nunca fixada em valores_fixos. Uma faixa "
        "de uma linha escolhida por indice nao e colecao: use celula_de_tabela com "
        "seletor_linha.valor_aceito. Nunca misture os dois modos. "
