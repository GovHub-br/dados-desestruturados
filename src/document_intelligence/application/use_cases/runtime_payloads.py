...
from document_intelligence.infrastructure.governance.operational_metadata import (
        ...
        return {
            ...
            "inputs": {
                "contrato_semantico": (
                    ...
                    f"{config.minio_contract_prefix}/v1.7.0/contrato_semantico_construtora.json"
                ),
                "layout_signature": (
                    f"minio://{config.minio_bucket}/"
